...
### This Repo provides code for evaluating LLMs on LEXam. [[Huggingface Dataset]]([https://huggingface.co/datasets/JingweiNi/LEXam](https://huggingface.co/datasets/LEXam-Benchmark/LEXam)) [[Paper]]()
